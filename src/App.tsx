...
import { 
  ...
  ArrowRight,
  AlertCircle,
  ClipboardList // Renamed from Clipboard to avoid conflicts and clarity
} from 'lucide-react';
...
const STEPS = [
  ...
  { id: 'clientServices', title: 'Client Services', icon: ClipboardList, description: 'Service flow and participation' },
